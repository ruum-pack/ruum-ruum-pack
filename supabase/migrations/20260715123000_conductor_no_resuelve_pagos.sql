-- RT-31 -- El conductor no resuelve pasos de pago.
--
-- La ejecucion operativa del conductor termina al confirmar la entrega. Los
-- cobros y estados de pago viven en app-usuario / panel-admin / Stripe.
