...
insert into public.traslados (id, usuario_id, vehiculo_id, distancia_km, tiempo_estimado_horas, estado,
  ...
  origen_lat, origen_lng, origen_direccion, destino_lat, destino_lng, destino_direccion, tipo_pago, precio_cotizado, clave_idempotencia)
values ('a1e00001-0000-4000-8000-000000000001', 'a1c00001-0000-4000-8000-000000000001',
  ...
  19.43,-99.13,'Origen',19.50,-99.20,'Destino', 'anticipado', 500.00, gen_random_uuid());
...
values ('a1e00001-0000-4000-8000-000000000002', 'a1c00001-0000-4000-8000-000000000001',
  ...
  19.43,-99.13,'Origen2',19.50,-99.20,'Destino2', 'anticipado', 600.00, gen_random_uuid());
