...
insert into public.usuarios (id, auth_user_id, tipo_cuenta, rol, estado_verificacion, empresa_id, rfc, razon_social, regimen_fiscal, codigo_postal_fiscal, uso_cfdi, correo_facturacion) values
  ...
  ('90800000-0000-4000-8000-000000000002', '90800000-0000-4000-8000-000000000002', 'personal', 'personal', 'verificado', null, null, null, null, null, null, null);
...
select is(
  (select rfc from public.usuarios where id = '90800000-0000-4000-8000-000000000002'),
  'XAXX010101000',
...
select ok(
  (select (u.rfc = 'NUEVO800101AB2' and e.rfc = 'NUEVO800101AB2' and u.razon_social = e.razon_social and u.correo_facturacion = e.correo_facturacion)
   ...
   where u.id = '90800000-0000-4000-8000-000000000001'),
...
select is(
  (select rfc from public.usuarios where id = '90800000-0000-4000-8000-000000000001'),
  'NUEVO800101AB2',
