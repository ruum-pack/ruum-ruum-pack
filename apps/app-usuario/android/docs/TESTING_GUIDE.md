...
# 2. Navegar a: app/src/test/java/com/moviliax/ruumruum/usuario
...
./gradlew connectedAndroidTest -P android.testInstrumentationRunnerArguments.class=com.moviliax.ruumruum.usuario.ExampleInstrumentedTest
```
...
│   │   │   └── java/com/moviliax/ruumruum/usuario/
│   │   │       └── MainActivity.java
...
```java
package com.moviliax.ruumruum.usuario;
...
public class MyInstrumentedTest {
    ...
    public void testAppContext() {
        ...
        assertEquals("com.moviliax.ruumruum.usuario", appContext.getPackageName());
    }
}
```
...
1. Verifica que los archivos .java esten en el directorio correcto:
   - Unit tests: `app/src/test/java/com/moviliax/ruumruum/usuario/`
   - Instrumentation tests: `app/src/androidTest/java/com/moviliax/ruumruum/usuario/`
...
El proyecto usa Capacitor. Para pruebas locales, puedes configurar la variable de entorno:
