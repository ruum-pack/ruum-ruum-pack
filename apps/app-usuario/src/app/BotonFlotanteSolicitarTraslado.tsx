...
export function BotonFlotanteSolicitarTraslado({ mostrar }: BotonFlotanteSolicitarTrasladoProps) {
  ...
  return (
    <Link
      ...
      className="fixed bottom-[80px] right-4 z-40 inline-flex items-center justify-center rounded-full bg-white px-5 py-3 font-body text-sm font-semibold text-[#14213d] shadow-[0_18px_45px_rgba(20,33,61,0.22)] ring-1 ring-black/10 transition hover:-translate-y-0.5 hover:bg-[#f7f8fb] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#14213d] sm:right-8"
    >
      Solicitar traslado
    </Link>
  );
