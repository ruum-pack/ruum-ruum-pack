...
export function useNuevoTraslado() {
  async function crear(
    ...
    coordenadas: CoordenadasTraslado & { paradasCoords?: CoordenadasParada[] }, claveIdempotencia: string
  ) {
    ...
    const traslado = await crearTraslado(cliente, payload.vehiculo, payload.traslado, claveIdempotencia, payload.paradas);
