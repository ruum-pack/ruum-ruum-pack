...
export const USUARIO_DEMO: UsuarioRow = {
  ...
  terminos_aceptados_en: new Date(Date.now() - 1000 * 60 * 60 * 24 * 30).toISOString(),
  doc_identidad_url: "demo-usuario/identidad.pdf",
  doc_identidad_subido_en: new Date(Date.now() - 1000 * 60 * 60 * 24 * 29).toISOString(),
  ...
  numero: "1234",
  referencias: "Acceso por recepción",
  direccion_principal: "Av. Insurgentes Sur 1234, Roma Sur",
  correo_facturacion: "cliente.demo@ruum.mx",
