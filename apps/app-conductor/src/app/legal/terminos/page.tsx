      ...
      <div className="conductor-content max-w-3xl">
        ...
        <article className="rounded-2xl border border-ink/10 bg-white px-6 py-8 shadow-[0_1px_2px_rgba(26,31,46,0.08)] sm:px-10">
          <header className="mb-8 border-b border-ink/10 pb-6">
            ...
            <h1 className="mt-2 font-display text-2xl font-semibold text-ink">Términos y condiciones</h1>
            <p className="mt-1 font-body text-sm text-ink/50">ruum ruum by Movilia — vigentes desde el 3 de julio de 2026</p>
          </header>
          ...
          <div className="space-y-6 font-body text-sm leading-7 text-ink/80">
            ...
            <section>
              <h2 className="mb-3 font-display text-base font-semibold text-ink">1. Definiciones</h2>
              ...
              <p className="mt-2"><strong>Pasaporte Digital:</strong> Documento digital generado por la Plataforma que contiene la evidencia fotográfica, el estado del vehículo y la trazabilidad del traslado.</p>
            </section>

            <section>
              <h2 className="mb-3 font-display text-base font-semibold text-ink">2. Registro y certificación CONCER</h2>
              <p>
            ...
            <section>
              <h2 className="mb-3 font-display text-base font-semibold text-ink">3. Obligaciones del Conductor</h2>
              <p>
            ...
            <section>
              <h2 className="mb-3 font-display text-base font-semibold text-ink">4. Pagos y cancelaciones</h2>
              <p>
            ...
            <section>
              <h2 className="mb-3 font-display text-base font-semibold text-ink">5. Evidencia y responsabilidad</h2>
              <p>
                El Pasaporte Digital constituye evidencia del estado del vehículo al inicio y al final de cada
            ...
            <section>
              <h2 className="mb-3 font-display text-base font-semibold text-ink">6. Modificaciones</h2>
              <p>
