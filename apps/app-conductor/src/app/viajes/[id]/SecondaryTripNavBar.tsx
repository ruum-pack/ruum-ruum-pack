...
export function SecondaryTripNavBar({
  ...
  const [tabActiva, setTabActiva] = useState<"detalles" | "gastos" | "incidencia">("detalles");
  ...
  return (
    <>
      ...
      {/* ------------------------------------------------------------------ */}
      <nav aria-label="Navegación secundaria del traslado" className="w-full bg-[#090D1A]/95 border-t border-border/15 backdrop-blur-md px-3 py-2 select-none">
