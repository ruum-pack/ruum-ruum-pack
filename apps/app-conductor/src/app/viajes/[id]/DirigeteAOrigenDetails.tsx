      ...
      <div className="mt-6 bg-[#0E1524] rounded-[2rem] border border-border/15 p-5 shadow-lg relative">
        ...
        <div className="mt-5 flex items-center">
          <div className="flex flex-1 items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-[9px] text-emerald-400 font-bold uppercase tracking-widest">DISTANCIA AL ORIGEN</span>
          ...
          <div className="flex flex-1 items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-[9px] text-emerald-400 font-bold uppercase tracking-widest">TIEMPO EST. AL ORIGEN</span>
