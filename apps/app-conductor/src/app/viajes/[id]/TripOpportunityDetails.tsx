                    ...
                    {origenLat && origenLng ? (
                      <>
                        ...
                        <button
                          type="button"
                          onClick={() => setMapaExpandido(true)}
                          className="absolute top-3 right-3 bg-black/70 backdrop-blur-md border border-white/20 rounded-lg px-3 py-1.5 text-[10px] font-bold text-white hover:bg-black/90 transition-colors z-20 flex items-center gap-1 select-none shadow-md cursor-pointer"
                        >
        ...
        {esOferta ? (
          <>
            <div className="flex flex-col gap-3 w-full">
              {/* ACEPTAR TRASLADO Button con Temporizador y barra de progreso */}
              <button
                type="button"
                onClick={() => setConfirmarAccion("aceptar")}
                disabled={procesando || segundosRestantes === 0}
                className="relative overflow-hidden w-full min-h-[52px] rounded-full bg-[#00C26F] hover:bg-[#00A960] text-white font-display text-sm font-bold tracking-widest uppercase transition-all cursor-pointer shadow-md select-none flex items-center justify-center gap-2 focus:outline-hidden disabled:opacity-50"
              >
              ...
              {/* RECHAZAR OFERTA Button (Outline Rojo) */}
              <button
                type="button"
                onClick={() => setConfirmarAccion("rechazar")}
                disabled={procesando}
                className="w-full min-h-[48px] rounded-full border border-red-500/60 bg-transparent text-red-500 hover:bg-red-500/10 font-display text-xs font-bold tracking-widest uppercase transition-all cursor-pointer select-none flex items-center justify-center gap-2"
              >
                Rechazar oferta
              </button>
            </div>
