...
type IconoNombre = "dashboard"|"viajes"|"mapa"|"sla"|"conductor"|"usuario"|"empresa"|"incidencia"|"disputa"|"reclamo"|"pagos"|"tarifas"|"documentos"|"reportes"|"configuracion"|"evidencia"|"auditoria";
...
function Icono({ nombre }: { nombre: IconoNombre }) {
  const map: Record<IconoNombre, React.ReactNode> = {
    ...
    conductor: <IcConductor />, usuario: <IcUsuario />, empresa: <IcEmpresa />,
