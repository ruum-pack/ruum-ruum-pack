            ...
            return (
              <PassportCard key={disputa.id}>
                ...
                <dl className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                  <div><dt className="font-body text-xs uppercase tracking-wide text-ink/45">Viaje</dt><dd className="mt-1 font-body text-sm font-medium"><Link href={`/viajes/${disputa.traslado_id}`} className="text-route">{disputa.traslado_id.slice(0, 8).toUpperCase()}</Link></dd></div>
