    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="grid grid-cols-3 gap-3 border-b border-mist-dim px-6 py-3">
        <div className="rounded-xl bg-route-soft px-4 py-3">
          <p className="font-mono-ruum text-xs text-route/70">Activos</p>
          ...
          {sel && (
            <div className="border-b border-mist-dim bg-mist-dim/40 p-4">
              ...
              <Link
                ...
                className="mt-3 block w-full rounded-lg border border-route/30 bg-route-soft py-2 text-center font-body text-sm text-route hover:bg-route hover:text-white transition-colors"
              >
                Ver pasaporte →
              </Link>
            </div>
