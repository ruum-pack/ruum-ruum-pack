...
export default function PaginaConfiguracionAdmin() {
  return (
    <main className="mx-auto max-w-6xl px-6 py-8 sm:px-8 sm:py-10">
      ...
      <p className="mt-1 font-body text-sm text-ink/55">Parámetros operativos, permisos internos, seguridad y bitácora.</p>
        ...
        {CONFIG.map((item) => (
          <PassportCard key={item}>
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="rounded-full border border-ink/15 px-2.5 py-1 font-mono-ruum text-[10px] uppercase tracking-wide text-ink/40">
                Próximamente
              </span>
            </div>
          </PassportCard>
