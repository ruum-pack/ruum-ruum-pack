...
const PERMISOS_POR_ROL: Record<RolAdminOperativo, ReadonlySet<PermisoAdmin>> = {
  ...
  direccion: new Set(["dashboard:leer", "viajes:leer", "viajes:gestionar", "pagos:leer", "pagos:exportar", "tarifas:leer", "tarifas:editar", "incidencias:leer", "disputas:leer", "disputas:resolver", "reclamos_seguro:leer", "reclamos_seguro:gestionar", "pagos:ejecutar", "aprobaciones:aprobar", "auditoria:leer", "exportaciones:crear", "capacidades:administrar"])
};
