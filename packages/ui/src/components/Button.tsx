...
const ESTILOS: Record<NonNullable<ButtonProps["variant"]>, string> = {
  ...
  emergency:
    "border-2 border-danger-action bg-danger-action text-white shadow-sm hover:brightness-105 hover:shadow-md active:scale-[0.98] focus-visible:outline-danger-action"
};
